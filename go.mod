...
require (
	...
	github.com/hashicorp/consul/api v1.10.1-0.20240118203443-814c007d4f04 // indirect
	github.com/hashicorp/consul/proto-public v0.1.2-0.20231212183607-c4caa3147d5a // indirect
