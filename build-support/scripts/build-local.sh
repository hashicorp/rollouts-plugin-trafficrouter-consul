...
Description:
   This script will build the rollouts-plugin-trafficrouter-consul binary on the local system.
...
function main {
   ...
   build_local "${sdir}" "${build_os}" "${build_arch}" "rollouts-plugin-trafficrouter-consul" || return 1
